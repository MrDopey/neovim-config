...
vim.keymap.set("n", "<leader>hs", function() harpoon:list():prev() end, { desc = "harpoon previous item" })
vim.keymap.set("n", "<leader>ht", function() harpoon:list():next() end, { desc = "harpoon next item" })
